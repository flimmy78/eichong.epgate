...
public class ElectricPileCache {
	...
	public void onNetStatus(int epStatus)
	{
		...
		for(int i=1;i<= gunNum;i++)
		{
            ...
            if (canOperate1) loopEpGunCache.handleECSignleOrgNo(UserConstants.ORG_TCEC_ECHONG, 0);
	...
	public void sendStatus(int status)
	{
        ...
        {
            EpGunCache loopEpGunCache = EpGunService.getEpGunCache(code, i);
            if (canOperate) loopEpGunCache.handleECSignleOrgNo(UserConstants.ORG_EC, status);
