...
public class BespCache {
	...
	public void onRedoBespokeSuccess()
	{
		...
		{
			UserService.subAmt(getAccountId(), addingFronzeAmt, new BigDecimal(0),this.bespNo);
		}
	...
	public void onBespokeSuccess()
	{
		...
		if(getPayMode() ==  EpConstants.P_M_FIRST)
		{
			...
			UserService.subAmt(getAccountId(), addingFronzeAmt, new BigDecimal(0),getBespNo());
		}
