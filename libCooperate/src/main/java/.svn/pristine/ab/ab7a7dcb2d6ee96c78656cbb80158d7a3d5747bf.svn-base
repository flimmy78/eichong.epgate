 ...
 */
public class TCECRTAPush extends Push {
    private static final Logger logger = LoggerFactory.getLogger(LogUtil.getLogName(TCECRTAPush.class.getName()));
    ...
    public boolean init(String filename) {
        ...
        orgNo = Integer.valueOf(conf.getEChongProperties(KeyConsts.ORG_NO, "9029"));
        mode = Integer.valueOf(conf.getEChongProperties(KeyConsts.REAL_DATA_MODE, "1"));
        period = Integer.valueOf(conf.getEChongProperties(KeyConsts.REAL_DATA_PERIOD, "15"));
    ...
    public void onChargeEpResp(String token, int orgNo, String userIdentity, String epCode, int epGunNo, String extra, int ret, int errorCode) {
        ...
        try {
            ...
            TCECCRTAService.addRealData(resMap.get("ConnectorID") + Symbol.SPLIT + resMap.get("StartTime")
    ...
    public void onEpStatusChange(String token, int orgNo, String userIdentity, String epCode, int epGunNo, int inter_type, Map<String, Object> realData, String extra) {
        try {
            ...
            TCECCRTAService.addRealData(connectorID + Symbol.SPLIT + UserConstants.ORG_TCEC_ShenZhenTraffic
    ...
    public void onRealData(String token, int orgNo, String userIdentity, String epCode, int epGunNo, int inter_type, float servicePrice, Map<String, Object> realData, String extra) {
        try {
            ...
            if (resMap.size() > 0) {
                TCECCRTAService.addRealData(resMap.get("ConnectorID") + Symbol.SPLIT + UserConstants.ORG_TCEC_ShenZhenTraffic
    ...
    public void onChargeOrder(String token,int orgNo,String userIdentity,String epCode,int epGunNo
        ...
        try {
            ...
            if (stopCharge.size() > 0) {
                TCECCRTAService.addRealData(stopCharge.get("ConnectorID") + Symbol.SPLIT + DateUtil.getCurrentSeconds()
            ...
            TCECCRTAService.addRealData(order.get("ConnectorID") + Symbol.SPLIT + DateUtil.getCurrentSeconds()
