...
public class KeyConsts {
    ...
    public static final String TCEC_SGCC_SETTING = "tcecsgcc.properties";
    public static final String TCEC_NANCHONG_SETTING = "tcecnanchong.properties";
    public static final String TCEC_ALIPAY_SETTING = "tcec_alipay.properties";
    public static final String TCEC_HAINAN_SETTING = "tcec_hainan.properties";
    public static final String TCEC_CONFIG_SETTING = "tcec_config.properties";
    public static final String APP_ID = "app_id";
    public static final String APP_KEY = "app_key";
    public static final String APP_SECRET = "appsecret";
    public static final String TCEC_START_CHARGE = "notification_start_charge_result";
    public static final String TCEC_STATION_STATUS = "notification_stationStatus";
    public static final String TCEC_STOP_CHARGE = "notification_stop_charge_result";
    public static final String TCEC_CHARGE_STATUS = "notification_equip_charge_status";
    public static final String TCEC_CHARGE_ORDER = "notification_charge_order_info";
    public static final String TCEC_SEND_URL = "send_url_";
    ...
    public static String WANMA_OPERATOR_ID = "common_operator_id";
