 ...
 */
public class TCECChangAnPush extends Push {
    private static final Logger logger = LoggerFactory.getLogger(LogUtil.getLogName(TCECChangAnPush.class.getName()));
    ...
    public boolean init(String filename) {
        ...
        orgNo = Integer.valueOf(conf.getEChongProperties(KeyConsts.ORG_NO, "9027"));
    ...
    public void onChargeEpResp(String token, int orgNo, String userIdentity, String epCode, int epGunNo, String extra, int ret, int errorCode) {
        ...
        try {
            ...
            TCECChangAnService.addRealData(resMap.get("ConnectorID") + Symbol.SPLIT + resMap.get("StartTime")
    ...
    public void onEpStatusChange(String token, int orgNo, String userIdentity, String epCode, int epGunNo, int inter_type, Map<String, Object> realData, String extra) {
        try {
            ...
            TCECChangAnService.addRealData(connectorID + Symbol.SPLIT + UserConstants.ORG_TCEC_ChangAn
    ...
    public void onRealData(String token, int orgNo, String userIdentity, String epCode, int epGunNo, int inter_type, float servicePrice, Map<String, Object> realData, String extra) {
        try {
            ...
            if (resMap.size() > 0) {
                TCECChangAnService.addRealData(resMap.get("ConnectorID") + Symbol.SPLIT + UserConstants.ORG_TCEC_ChangAn
    ...
    public void onChargeOrder(String token,int orgNo,String userIdentity,String epCode,int epGunNo
        ...
        try {
            ...
            if (stopCharge.size() > 0) {
                TCECChangAnService.addRealData(stopCharge.get("ConnectorID") + Symbol.SPLIT + DateUtil.getCurrentSeconds()
            ...
            TCECChangAnService.addRealData(order.get("ConnectorID") + Symbol.SPLIT + DateUtil.getCurrentSeconds()
