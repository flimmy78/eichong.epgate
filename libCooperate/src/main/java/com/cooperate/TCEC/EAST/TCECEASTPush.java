 ...
 */
public class TCECEASTPush extends Push {
    private static final Logger logger = LoggerFactory.getLogger(LogUtil.getLogName(TCECEASTPush.class.getName()));
    ...
    public boolean init(String filename) {
        ...
        orgNo = Integer.valueOf(conf.getEChongProperties(KeyConsts.ORG_NO, "9028"));
    ...
    public void onChargeEpResp(String token, int orgNo, String userIdentity, String epCode, int epGunNo, String extra, int ret, int errorCode) {
        ...
        try {
            ...
            TCECEASTService.addRealData(resMap.get("ConnectorID") + Symbol.SPLIT + resMap.get("StartTime")
    ...
    public void onEpStatusChange(String token, int orgNo, String userIdentity, String epCode, int epGunNo, int inter_type, Map<String, Object> realData, String extra) {
        try {
            ...
            TCECEASTService.addRealData(connectorID + Symbol.SPLIT + UserConstants.ORG_TCEC_DongFeng
    ...
    public void onRealData(String token, int orgNo, String userIdentity, String epCode, int epGunNo, int inter_type, float servicePrice, Map<String, Object> realData, String extra) {
        try {
            ...
            if (resMap.size() > 0) {
                TCECEASTService.addRealData(resMap.get("ConnectorID") + Symbol.SPLIT + UserConstants.ORG_TCEC_DongFeng
    ...
    public void onChargeOrder(String token,int orgNo,String userIdentity,String epCode,int epGunNo
        ...
        try {
            ...
            if (stopCharge.size() > 0) {
                TCECEASTService.addRealData(stopCharge.get("ConnectorID") + Symbol.SPLIT + DateUtil.getCurrentSeconds()
            ...
            TCECEASTService.addRealData(order.get("ConnectorID") + Symbol.SPLIT + DateUtil.getCurrentSeconds()
