...
public class TCECEVCPush extends Push {
    private static final Logger logger = LoggerFactory.getLogger(LogUtil.getLogName(TCECEVCPush.class.getName()));
    ...
    public boolean init(String filename) {
        ...
        orgNo = Integer.valueOf(conf.getEChongProperties(KeyConsts.ORG_NO, "9011"));
    ...
    public void onChargeEpResp(String token, int orgNo, String userIdentity, String epCode, int epGunNo, String extra, int ret, int errorCode) {
        ...
        try {
            ...
            TCECEVCService.addRealData(resMap.get("ConnectorID") + Symbol.SPLIT + resMap.get("StartTime")
    ...
    public void onEpStatusChange(String token, int orgNo, String userIdentity, String epCode, int epGunNo
        ...
        try {
            ...
            TCECEVCService.addRealData(connectorID + Symbol.SPLIT + DateUtil.getCurrentSeconds()
    ...
    public void onRealData(String token, int orgNo, String userIdentity, String epCode, int epGunNo, int inter_type, float servicePrice, Map<String, Object> realData, String extra) {
        try {
            ...
            if (resMap.size() > 0) {
                TCECEVCService.addRealData(resMap.get("ConnectorID") + Symbol.SPLIT + DateUtil.getCurrentSeconds()
    ...
    public void onChargeOrder(String token, int orgNo, String userIdentity, String epCode, int epGunNo,
        ...
        try {
            ...
            if (stopCharge.size() > 0) {
                TCECEVCService.addRealData(stopCharge.get("ConnectorID") + Symbol.SPLIT + DateUtil.getCurrentSeconds()
            ...
            TCECEVCService.addRealData(order.get("ConnectorID") + Symbol.SPLIT + DateUtil.getCurrentSeconds()
