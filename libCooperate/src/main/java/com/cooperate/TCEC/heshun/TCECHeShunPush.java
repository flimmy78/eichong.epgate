...
public class TCECHeShunPush extends Push {
    private static final Logger logger = LoggerFactory.getLogger(LogUtil.getLogName(TCECHeShunPush.class.getName()));
    ...
    public boolean init(String filename) {
        ...
        orgNo = Integer.valueOf(conf.getEChongProperties(KeyConsts.ORG_NO, "9016"));
    ...
    public void onEpStatusChange(String token, int orgNo, String userIdentity, String epCode, int epGunNo
        ...
        try {
            ...
            TCECHeShunService.addRealData(connectorID + Symbol.SPLIT + DateUtil.getCurrentSeconds()
